...
const createTransaction = async (rawMerchantString: string): Promise<number> => {
...
describe('useRulesEngine', () => {
  it('should apply rules and update transactions in db', async () => {
    ...
    let rulesResult: Awaited<ReturnType<typeof result.current.applyRulesToNewTransactions>>
    await act(async () => {
