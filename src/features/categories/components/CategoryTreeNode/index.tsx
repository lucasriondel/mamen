...
import { ChevronRight, MoreHorizontal, Plus, Pencil, ArrowUp, ArrowDown, Trash2 } from 'lucide-react'
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Icon */}
        <Icon className="h-4 w-4 shrink-0 ml-2 text-muted-foreground" aria-hidden="true" />
