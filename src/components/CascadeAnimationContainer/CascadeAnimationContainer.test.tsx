...
describe('CascadeAnimationContainer', () => {
  ...
  it('should apply cascade-highlight data attribute to animating transaction IDs', () => {
    render(
      <CascadeAnimationContainer transactionIds={['1', '2', '3']} isAnimating={true}>
        <div data-transaction-id="1" data-testid="tx-1">Tx 1</div>
        <div data-transaction-id="2" data-testid="tx-2">Tx 2</div>
        <div data-transaction-id="3" data-testid="tx-3">Tx 3</div>
        <div data-transaction-id="4" data-testid="tx-4">Tx 4</div>
      </CascadeAnimationContainer>,
    )
