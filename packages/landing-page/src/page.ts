 ...
 *
 * What that copy must not do is oversell: mamen is one person's self-hosted
 * tool, there is nothing to sign up for, and a landing page that implies
 * otherwise is worse than none. The colours caught up with the app's in #146,
 * so the page reads as the same product rather than a second one.
 *
