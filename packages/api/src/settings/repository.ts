...
import { NotFound, Paged, Setting, type SettingKey } from "@mamen/shared/contract";
...
const requireOne = (found: Option.Option<Setting>, key: string): Effect.Effect<Setting, NotFound> =>
  Option.match(found, {
    onNone: () => Effect.fail(new NotFound({ resource: "setting", id: key })),
 ...
 */
export class SettingRepo extends Effect.Service<SettingRepo>()("api/SettingRepo", {
