...
import { deleteIssuerImage, persistIssuerImage, persistIssuerImageFromBytes } from "./image";
    ...
    return handlers
      ...
      .handle("remove", (_) =>
        ...
        repo.getById(_.path.id).pipe(
          Effect.tap((issuer) =>
            issuer.imageUrl !== undefined ? deleteIssuerImage(issuer.imageUrl) : Effect.void,
          ),
