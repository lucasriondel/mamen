...
describe('AccountsPage - Empty State', () => {
  it('renders empty state when no accounts exist', async () => {
    ...
    expect(
      screen.getByText('Create your first bank account to start importing statements.')
    ).toBeInTheDocument()
  })
  ...
  it('opens create modal when Add Account is clicked in empty state', async () => {
    ...
    expect(screen.getByText('Add a new bank account to organize your statements.')).toBeInTheDocument()
  })
})
...
describe('AccountsPage - CRUD Operations', () => {
  ...
  it('shows correct transaction count in delete confirmation', async () => {
    ...
    expect(await screen.findByText(/remove 2 transactions/)).toBeInTheDocument()
  })
})
