      ...
      <PopoverContent className="w-56 p-3">
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            <span className="text-gousse-muted text-xs uppercase tracking-wide">Preset</span>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            <label htmlFor={fieldId} className="text-gousse-muted text-xs uppercase tracking-wide">
              Hex colour
            </label>
            <Input
              id={fieldId}
            ...
            <div className="flex items-center justify-between gap-2">
              {value === null ? (
                ...
                <Button variant="ghost" size="sm" onClick={() => commit(null)} disabled={pending}>
                  Auto
                </Button>
              )}
