...
/** The two imported months the `monthProgress` fixtures stand on. */
const isImportedMonth = (month: string) => ["2026-01", "2026-05"].includes(month);
...
describe("monthProgress", () => {
  ...
  it("counts only elapsed months in the current year's denominator", () => {
    const cells = monthCells(2026, currentMonth, isImportedMonth);
