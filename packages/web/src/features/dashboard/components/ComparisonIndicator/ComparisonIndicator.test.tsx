...
describe("ComparisonIndicator", () => {
	it("renders upward indicator with destructive color", () => {
		render(
			<ComparisonIndicator comparison={upComparison} label="vs last month" />,
		);
	...
	it("renders downward indicator with success color", () => {
		render(
			<ComparisonIndicator comparison={downComparison} label="vs last month" />,
		);
	...
	it("renders flat indicator with muted color", () => {
		render(
			<ComparisonIndicator comparison={flatComparison} label="vs last month" />,
		);
	...
	it('renders "No previous data" when undefined', () => {
		render(
			<ComparisonIndicator comparison={undefined} label="vs last month" />,
		);
	...
	it('shows "New" for category with no previous data in sm size', () => {
		render(
			<ComparisonIndicator
				comparison={newSpendingComparison}
				label="vs last month"
				size="sm"
			/>,
		);
