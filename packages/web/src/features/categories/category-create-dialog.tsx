...
export function CategoryCreateDialog({
  ...
  const parentCategory = parentId === null ? undefined : categories.find((c) => c.id === parentId);
      ...
      <DialogContent ref={setDialogNode}>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Name it, choose where it sits, and give it an icon and a colour. Leave the colour
              alone and it is inherited from the category above it.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex items-end gap-2">
            <label className="flex min-w-0 flex-1 flex-col gap-1 text-gousse-muted text-sm">
              ...
              <Input
                ...
                // oxlint-disable-next-line jsx-a11y/no-autofocus -- the one field never right by default, per the note above
                autoFocus
              />
            </label>
