...
import { type Appearance, AppearancePicker } from "@/components/appearance-picker";
  ...
  return (
    <div
      ...
      className={cn(
        ...
        tintFor(depth),
        !isRoot && "hover:bg-gousse-ink/[0.035] focus-within:bg-gousse-ink/[0.035]",
        isRoot && "hover:bg-gousse-ink/[0.035] focus-within:bg-gousse-ink/[0.035]",
      )}
    >
      {isFolder ? (
        ...
        >
          ...
          <ChevronRight
            className={cn("size-[13px] transition-transform duration-150", expanded && "rotate-90")}
            aria-hidden
          />
        </button>
      ) : (
