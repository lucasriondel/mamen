...
const DASHBOARD_PERIOD_OPTIONS: { value: DashboardTimePeriod; label: string }[] = [
...
export function DisplayPreferencesSection(): React.ReactElement {
  ...
  const handleAbsoluteAmountChange = async (
    ...
    if (isNaN(val) || val <= 0) return
    await updateDisplayPreferences({
      anomalyThreshold: { ...preferences.anomalyThreshold, absoluteAmount: val },
    })
    toast.success('Preferences updated')
  }
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="anomaly-multiplier">Anomaly threshold multiplier</Label>
