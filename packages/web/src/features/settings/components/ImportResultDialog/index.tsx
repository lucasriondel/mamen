						...
						{result.success && result.mode === "replace" && (
							<div className="rounded-md border p-3">
								...
								<p className="text-sm text-muted-foreground">
									{result.added.accounts} accounts, {result.added.transactions}{" "}
									transactions, {result.added.merchants} merchants imported
								</p>
							</div>
						)}
							...
							<div className="rounded-md border p-3">
								...
								<p className="text-sm text-muted-foreground">
									...
									{result.skipped.transactions > 0 && (
										<>
											{" "}
											Skipped {result.skipped.transactions} duplicate
											transactions.
										</>
									)}
								</p>
