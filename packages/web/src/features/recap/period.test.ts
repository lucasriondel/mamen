...
import { currentMonthPeriod, monthKeyOf, type Period, periodToFilter } from "./period";
...
describe("periodToFilter", () => {
  ...
  it("never filters on the import month", () => {
    expect(periodToFilter({ kind: "month", month: "2026-07" })).not.toHaveProperty("importMonth");
  });
