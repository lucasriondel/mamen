...
const renderModal = (props: Partial<React.ComponentProps<typeof MerchantAssignmentModal>> = {}) =>
  render(
...
describe('MerchantAssignmentModal', () => {
  ...
  it('shows category override checkbox when existing merchant selected', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByLabelText(/override category for this rule/i)).toBeInTheDocument()
    })
  })
