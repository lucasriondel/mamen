			...
			>
				...
				<form onSubmit={handleSubmit} className="flex flex-col gap-3">
					<div className="flex items-center gap-2">
						...
						<span className="min-w-0 truncate font-medium text-gousse-ink text-sm">
							{label}
						</span>
						{inherits ? (
							<span className="ml-auto text-gousse-muted text-xs">
								Inheriting
							</span>
						) : (
							<Button
