 ...
 * restyled onto the `--gousse-*` tokens (ADR 0003). The last and widest of the
 * three Radix conversions — after `Tooltip` (issue #99) and `Dialog` (issue
 * #100) — and the one that closed the seam: twelve call sites across
 * transactions, issuers, categories, accounts and the shared colour/icon pickers
 * all share this one surface.
 *
