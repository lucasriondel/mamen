...
export type TransactionRepository = BaseRepository<Transaction> & {
  ...
  getByAccountIdAndMonth: (accountId: number, importMonth: string) => Promise<Transaction[]>
  countByAccountIdAndMonth: (accountId: number, importMonth: string) => Promise<number>
  deleteByAccountIdAndMonth: (accountId: number, importMonth: string) => Promise<void>
  ...
  bulkAddReturningIds: (records: Omit<Transaction, 'id'>[]) => Promise<number[]>
  filterByPredicate: (predicate: (tx: Transaction) => boolean) => Promise<Transaction[]>
  filterIdsByPredicate: (predicate: (tx: Transaction) => boolean) => Promise<number[]>
}
