...
- **`packages/<name>/CONTEXT.md`** — the per-package glossary for the package you're about to work in.
- **`docs/adr/`** at the repo root — system-wide decisions. Also check **`packages/<name>/docs/adr/`** for package-scoped decisions in the area you're about to work in.
